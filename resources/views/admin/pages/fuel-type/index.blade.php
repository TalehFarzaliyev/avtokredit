...
@section('title', __('fuel-type.title_index'))
@section('content')
    <div class="page-content pt-0">
        <div class="content-wrapper">
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-create route="admin.fuel-type.create"/>
                    </div>
                            ...
                            @foreach($fuel_type as $fuel)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <x-edit route="admin.fuel-type.edit" :id="$fuel->id"/>
                                            <x-delete route="admin.fuel-type.destroy" :id="$fuel->id"/>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
