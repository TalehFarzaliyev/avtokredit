...
@section('title', __('gear.title_index'))
@section('content')
    <div class="page-content pt-0">
        <div class="content-wrapper">
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-create route="admin.gear.create"/>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($gears as $gear)
                                <tr>
                                    ...
                                    <td>{{ $gear->created_at->diffForHumans() }}</td>
                                    <td>{{ $gear->updated_at->diffForHumans() }}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <x-edit route="admin.gear.edit" :id="$gear->id"/>
                                            <x-delete route="admin.gear.destroy" :id="$gear->id"/>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
