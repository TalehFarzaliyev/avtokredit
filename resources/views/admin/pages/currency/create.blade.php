...
@section('title', __('currency.title_create'))
@section('content')
    <!-- Page content -->
                            ...
                            <div class="form-row">
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="form-group-feedback form-group-feedback-right">
                                        <input type="text" name="title" id="title" class="form-control @error('title') border-danger @enderror" placeholder="{{__('messages.title')}}" value="{{ old('title') }}">
                                    </div>
                                    @error('title')
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="form-group-feedback form-group-feedback-right">
                                        <input type="text" name="code" id="code" class="form-control @error('code') border-danger @enderror" placeholder="{{__('messages.code')}}" value="{{ old('code') }}">
                                    </div>
                                    @error('code')
                                    <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="form-group-feedback form-group-feedback-right">
                                        <input type="text" name="symbol_left" id="symbol_left" class="form-control @error('symbol_left') border-danger @enderror" placeholder="{{__('currency.symbol_left')}}" value="{{ old('symbol_left') }}">
                                    </div>
                                    @error('symbol_left')
                                    <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="form-group-feedback form-group-feedback-right">
                                        <input type="text" name="symbol_right" id="symbol_right" class="form-control @error('symbol_right') border-danger @enderror" placeholder="{{__('currency.symbol_right')}}" value="{{ old('symbol_right') }}">
                                    </div>
                                    @error('symbol_right')
                                    <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                                    @enderror
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="form-group-feedback form-group-feedback-right">
                                        <input type="number" step="1" name="decimal_places" id="decimal_places" class="form-control @error('decimal_places') border-danger @enderror" placeholder="{{__('currency.decimal_places')}}" value="{{ old('decimal_places') }}">
                                    </div>
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <div class="form-group-feedback form-group-feedback-right">
                                        <input type="number" step="0.01" name="value" id="value" class="form-control @error('value') border-danger @enderror" placeholder="{{__('messages.value')}}" value="{{ old('value') }}">
                                    </div>
                                    @error('value')
                                    <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                                    @enderror
