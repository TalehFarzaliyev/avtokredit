...
@section('title', __('technical_specification.title_index'))
@section('content')
    <div class="page-content pt-0">
        <div class="content-wrapper">
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-create route="admin.technical_specification.create"/>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($technical_specifications as $technical_specification)
                                <tr>
                                    ...
                                    <td>{{ $technical_specification->created_at->diffForHumans() }}</td>
                                    <td>{{ $technical_specification->updated_at->diffForHumans() }}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <x-edit route="admin.technical_specification.edit" :id="$technical_specification->id"/>
                                            <x-delete route="admin.technical_specification.destroy" :id="$technical_specification->id"/>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
                ...
                {{ $technical_specifications->links() }}
            </div>
        </div>
    </div>
@stop
