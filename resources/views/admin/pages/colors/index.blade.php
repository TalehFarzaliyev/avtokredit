...
@section('title', __('color.title_index'))
@section('content')
    <div class="page-content pt-0">
        <div class="content-wrapper">
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-create route="admin.color.create"/>
                    </div>
                            ...
                            @foreach($colors as $color)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <x-edit route="admin.color.edit" :id="$color->id"/>
                                            <x-delete route="admin.color.destroy" :id="$color->id"/>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
