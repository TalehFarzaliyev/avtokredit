...
@section('title', __('transmission.title_index'))
@section('content')
    <div class="page-content pt-0">
        <div class="content-wrapper">
            <div class="content">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-create route="admin.transmission.create"/>
                    </div>
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($transmissions as $transmission)
                                <tr>
                                    ...
                                    <td>{{ $transmission->created_at->diffForHumans() }}</td>
                                    <td>{{ $transmission->updated_at->diffForHumans() }}</td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <x-edit route="admin.transmission.edit" :id="$transmission->id"/>
                                            <x-delete route="admin.transmission.destroy" :id="$transmission->id"/>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
