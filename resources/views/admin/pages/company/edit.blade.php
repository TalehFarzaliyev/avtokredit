...
@section('title', __('company.company')." ".__('messages.edit'))
@section('content')
<!-- Page content -->
                        ...
                        <div class="tab-pane fade show {{$loop->index == '0' ? 'active' : ''}}"
                           ...
                           <div class="form-row">
                              <div class="form-group col-sm-12">
                                 ...
                                 <input type="text" class="form-control " name="{{'slogan:'.$key}}" placeholder="{{__('company.slogan')}}" value="{{old('slogan:'.$key,$company->slogan)}}">
                                 @error('slogan:'.$key)
                           ...
                           <div class="form-row">
                              <div class="form-group col-sm-12">
                                 ...
                                 <input type="text" class="form-control " name="{{'working_days:'.$key}}" placeholder="{{__('company.working_days')}}" value="{{old('working_days:'.$key,$company->working_days)}}">
                           ...
                           <div class="form-row">
                              <div class="form-group col-sm-12">
                                 ...
                                 <input type="text" class="form-control " name="{{'address:'.$key}}" placeholder="{{__('company.address')}}" value="{{old('address:'.$key,$company->address)}}">
                                 @error('address:'.$key)
                                 <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                                 @enderror
                              </div>
                           ...
                           <div class="form-row">
                              <div class="form-group col-sm-12">
                                 ...
                                 <input type="text" class="form-control " name="{{'description:'.$key}}" placeholder="{{__('messages.description')}}" value="{{old('description:'.$key,$company->description)}}">
                     ...
                     <div class="form-row">
                        <div class="form-group col-sm-4">
                           ...
                           <div class="form-group-feedback form-group-feedback-right">
                              <input type="text" name="name" id="name" class="form-control @error('name') border-danger @enderror" placeholder="{{__('messages.name')}}" value="{{ old('name', $company->name) }}">
                           </div>
                           @error('name')
                           <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                           @enderror
                        ...
                        <div class="form-group col-sm-4">
                           ...
                           <div class="form-group-feedback form-group-feedback-right">
                              <select name="status" class="select" id="status" @error('status') data-container-css-class="border-danger text-danger" @enderror>
                                 <option {{ old('status', $company->status) == '1' ? 'selected': '' }} value="1">{{ __('messages.enable') }}</option>
                                 <option {{ old('status', $company->status) == '0'? 'selected': '' }}  value="0">{{ __('messages.disable') }}</option>
                              </select>
                           </div>
                           @error('status')
                           <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                        ...
                        <div class="form-group col-sm-4">
                           ...
                           <select name="company_group_id" class="form-control select" id="">
                              ...
                              @foreach($company_groups as $company_group)
                                 <option {{ old('company_group_id', $company->company_group_id) == $company_group->id ? 'selected': '' }} value="{{$company_group->id}}">{{$company_group->name}}</option>
                              @endforeach
                           </select>
                        ...
                        <div class="form-group col-sm-4">
                           ...
                           <div class="form-group-feedback form-group-feedback-right">
                              <input type="text" name="location_lat" id="location_lat" class="form-control @error('location_lat') border-danger @enderror" placeholder="{{__('company.location_lat')}}" value="{{ old('location_lat', $location['location_lat']) }}">
                           </div>
                           @error('location_lat')
                           <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                           @enderror
                        ...
                        <div class="form-group col-sm-4">
                           ...
                           <div class="form-group-feedback form-group-feedback-right">
                              <input type="text" name="location_lng" id="location_lng" class="form-control @error('location_lng') border-danger @enderror" placeholder="{{__('company.location_lng')}}" value="{{ old('location_lng', $location['location_lng']) }}">
                           </div>
                           @error('location_lng')
                           <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                           @enderror
                        ...
                        <div class="form-group col-sm-4">
                           ...
                           <div class="form-group-feedback form-group-feedback-right">
                              <input type="email" name="email" id="email" class="form-control @error('email') border-danger @enderror" placeholder="{{__('messages.email')}}" value="{{ old('email', $company->email) }}">
                           </div>
                           @error('email')
                           <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                           @enderror
                        ...
                        <div class="form-group col-sm-4">
                           ...
                           <div class="form-group-feedback form-group-feedback-right">
                              <input type="number" name="visit" id="visit" class="form-control @error('visit') border-danger @enderror" placeholder="{{__('company.visit')}}" value="{{ old('visit', $company->visit) }}">
                           </div>
                           @error('visit')
                           <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                           @enderror
                        ...
                        <div class="form-group col-sm-4">
                           ...
                           <div class="form-group-feedback form-group-feedback-right">
                              <input type="tel" name="phone" id="phone" class="form-control @error('phone') border-danger @enderror" placeholder="{{__('messages.phone')}}" value="{{ old('phone', $company->phone) }}">
                           </div>
                           @error('phone')
                           <span class="form-text font-weight-semibold text-danger">{{ $message }}</span>
                           @enderror
                        ...
                        <div class="form-group col-sm-6">
                           <label class="font-weight-semibold @error('image') text-danger @enderror" for="image">
                              {{__('messages.image')}}<a href="{{ asset('uploads/'.$company->image) }}" target="_blank">{{ __('messages.show') }} {{ __('messages.image') }}</a>
                           </label>
                           <div class="form-group-feedback form-group-feedback-right">
                        ...
                        <div class="form-group col-sm-6">
                           <label class="font-weight-semibold @error('cover_image') text-danger @enderror" for="cover_image">
                              {{__('company.cover_image')}} <a href="{{ asset('uploads/'.$company->cover_image) }}" target="_blank">{{ __('messages.show') }} {{ __('messages.image') }}</a>
                           </label>
                           <div class="form-group-feedback form-group-feedback-right">
