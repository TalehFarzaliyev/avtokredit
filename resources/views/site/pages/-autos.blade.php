        ...
        <div class="section-title-container">
            <div class="section-title">
                <ul class="breadcrumbs">
                    <li class="breadcrumbs-i"><a href="#">{{ $car->car_brand['name'] }}</a></li>
                    <li class="breadcrumbs-i"><a href="#">{{ $car->car_model['name'] }}</a></li>
                    <li class="breadcrumbs-i">Elan № {{ $car->id }}</li>
                </ul>
            </div>
        </div>
        <div class="page-content anounce-container">
            <div class="product-container">
                <div class="product credit">
                    ...
                    <h1 class="product-name product-name-row">Infiniti G37S,
                        <span class="nobr">3.7 L</span>,
                        <span class="nobr">{{ $car->year }} il</span>,
                        <span class="nobr">{{ $car->milliage }} km</span>
                    </h1>
                        ...
                        <div class="product-properties-container">
                            <ul class="product-properties">
                                ...
                                <li class="product-properties-i">
                                    ...
                                    <div class="product-properties-value"><a target="_blank" href="/makes/15-infiniti">{{ $car->car_brand['name'] }}</a></div>
                                </li>
                                <li class="product-properties-i">
                                    <label for="ad_model">Model</label>
                                    <div class="product-properties-value"><a target="_blank" href="/autos?q%5Bmake%5D%5B%5D=15&amp;q%5Bmodel%5D%5B%5D=864">{{ $car->car_model['name'] }}</a></div>
                                </li>
                                <li class="product-properties-i">
                                    <label for="ad_reg_year">Buraxılış ili</label>
                                    <div class="product-properties-value">
                                        <a target="_blank" href="/autos?q%5Bmake%5D%5B%5D=15&amp;q%5Bmodel%5D%5B%5D=864&amp;q%5Byear_from%5D=2012&amp;q%5Byear_to%5D=2012">{{ $car->year }}</a>
                                    </div>
                                </li>
                                <li class="product-properties-i">
                                ...
                                <li class="product-properties-i product-properties_price">
                                    ...
                                    <div class="product-properties-value">
                                        <div class="product-price">{{ $car->price }} <span>{{ $car->currency['symbol_right'] }}</span></div>
                                    </div>
                                </li>
